...
class RecipeForm extends Component {
  ...
  deleteIngredient = (e) => {
    ...
    this.setState((prevState) => ({
      ingredients: prevState.ingredients.filter(
        (ingredient, i) => i !== parseInt(deletedIngredientIndex)
      ),
    }));
  };
  ...
  deleteStep = (e) => {
    ...
    this.setState((prevState) => ({
      method: prevState.method.filter(
        (step, i) => i !== parseInt(deletedStepIndex)
      ),
    }));
  };
    ...
    return (
      <div>
        <form className="addNewRecipeForm" onSubmit={this.handleSubmit}>
          ...
          <button onClick={this.addIngredient} id="addIngredientButton">
          ...
          <button onClick={this.addStep} id="addStepButton">
            Add another step
          </button>
